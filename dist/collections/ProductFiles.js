...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, orders, ownProductFileIds, purchasedProductFileIds;
                ...
                case 0:
                    ...
                    return [4 /*yield*/, req.payload.find({
                            ...
                            where: {
                                ...
                                // where the current logged in users id matches the user property in the collection
                            },
                        })];
                case 1:
                    ...
                    purchasedProductFileIds = orders
                        ...
                        return order.products.map(function (product) {
                            if (typeof product === 'string')
                                return req.payload.logger.error('Search depth not sufficient to find product.');
    ...
    fields: [
        {
            ...
            type: 'relationship',
            relationTo: 'users',
            admin: { condition: function () { return false; } },
            hasMany: false,
            required: true,
        },
    ],
